...
/* export.twig */
class __TwigTemplate_88bf0d73e064dbe708a27b75a649bf9f2352b10df84fa345aa48bf75a8913517 extends Template
{
    private $source;
    private $macros = [];
...
yield _gettext("Select a template");
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["template"]) {
                ...
                yield "\"";
                yield (((0 === CoreExtension::compare(CoreExtension::getAttribute($this->env, $this->source, $context["template"], "getId", [], "method", false, false, false, 44), CoreExtension::getAttribute($this->env, $this->source, ($context["templates"] ?? null), "selected", [], "any", false, false, false, 44)))) ? (" selected") : (""));
                yield ">
                      ";
                // line 45
...
yield _gettext("Close");
  ...
  <form method=\"post\" action=\"";
    ...
    ";
        // line 102
        if ((0 !== CoreExtension::compare(($context["export_method"] ?? null), "custom-no-form"))) {
            // line 103
...
yield _gettext("Export method:");
        ...
        <div class=\"card-body\">
          <div class=\"form-check\">
            ...
            // line 107
            yield (((0 === CoreExtension::compare(($context["export_method"] ?? null), "quick"))) ? (" checked") : (""));
            yield ">
...
yield _gettext("Quick - display only the minimal options");
          ...
          <div class=\"form-check\">
            ...
            // line 111
            yield (((0 === CoreExtension::compare(($context["export_method"] ?? null), "custom"))) ? (" checked") : (""));
            yield ">
...
yield _gettext("Rows:");
        ...
        <div class=\"card-body\">
          <div class=\"form-check\">
            ...
            // line 140
            yield ((((null === CoreExtension::getAttribute($this->env, $this->source, ($context["rows"] ?? null), "allrows", [], "any", false, false, false, 140)) || (0 === CoreExtension::compare(CoreExtension::getAttribute($this->env, $this->source, ($context["rows"] ?? null), "allrows", [], "any", false, false, false, 140), 1)))) ? (" checked") : (""));
            yield ">
...
yield _gettext("Dump all rows");
          ...
          <div class=\"form-check mb-2\">
            ...
            // line 144
            yield ((( !(null === CoreExtension::getAttribute($this->env, $this->source, ($context["rows"] ?? null), "allrows", [], "any", false, false, false, 144)) && (0 === CoreExtension::compare(CoreExtension::getAttribute($this->env, $this->source, ($context["rows"] ?? null), "allrows", [], "any", false, false, false, 144), 0)))) ? (" checked") : (""));
            yield ">
...
($context["rows"] ?? null), "unlim_num_rows", [], "any", false, false, false, 153)) && (0 !== CoreExtension::compare(CoreExtension::getAttribute($this->env, $this->source, ($context["rows"] ?? null), "unlim_num_rows", [], "any", false, false, false, 153), 0)))) {
                // line 154
...
yield _gettext("Rename exported databases/tables/columns");
        ...
        ";
        // line 341
        if ((0 !== CoreExtension::compare(($context["export_type"] ?? null), "server"))) {
            // line 342
        ...
        // line 355
        yield (((($context["repopulate"] ?? null) || (0 === CoreExtension::compare(($context["export_asfile"] ?? null), false)))) ? (" checked") : (""));
        yield ">
...
yield _gettext("Character set of the file:");
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["charset"]) {
                ...
                yield "\"";
                // line 415
                yield ((((Twig\Extension\CoreExtension::testEmpty(($context["export_charset"] ?? null)) && (0 === CoreExtension::compare($context["charset"], "utf-8"))) || (0 === CoreExtension::compare($context["charset"], ($context["export_charset"] ?? null))))) ? (" selected") : (""));
                yield ">";
                // line 416
                yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($context["charset"], "html", null, true);
                // line 417
...
yield _gettext("None");
            ...
            if (($context["has_zip"] ?? null)) {
                ...
                // line 436
                yield (((0 === CoreExtension::compare(($context["selected_compression"] ?? null), "zip"))) ? (" selected") : (""));
                yield ">
                            ";
yield _gettext("zipped");
            ...
            if (($context["has_gzip"] ?? null)) {
                ...
                // line 442
                yield (((0 === CoreExtension::compare(($context["selected_compression"] ?? null), "gzip"))) ? (" selected") : (""));
                yield ">
                            ";
yield _gettext("gzipped");
        ...
        yield "
              ";
        // line 454
        if (((0 === CoreExtension::compare(($context["export_type"] ?? null), "server")) || (0 === CoreExtension::compare(($context["export_type"] ?? null), "database")))) {
            // line 455
            yield "                <li class=\"list-group-item\">
                  <div class=\"form-check form-switch\">
...
yield _gettext("Export databases as separate files");
                // line 462
                yield "                      ";
            } elseif ((0 === CoreExtension::compare(($context["export_type"] ?? null), "database"))) {
                // line 463
                yield "                        ";
...
";
    ...
    {
        return new Source("", "export.twig", "/export/sd216/www/jp/r/e/gmoserver/1/0/sd0999110/hw-symphony.jp/phpmyadmin/templates/export.twig");
    }
}
