...
<div id="wapper">
  <header id="header">
    <div id="headerinnr">
      <h1 id="logo"><a href="/test/"><img src="<?php src();?>common/img/logo.png" class="fluidimg2" alt="浜松ウォーターシンフォニー株式会社"/></a></h1>
      <nav class="pcSubNavi">
        <ul>
      ...
      <nav class="pcGloNavi">
        <ul>
          <li class="gnav1"><a href="/test/"><i class="fa fa-home mgR05" aria-hidden="true"></i>HOME</a></li>
